...
double Surface_Area::Triangle(double base, double height){return 0.5*base*height;}
double Surface_Area::Rectangle(double length, double width) {return length*width;}
double Surface_Area::Parallelogram(double base, double height) {return base*height;}
